...
<body>
                    ...
                    <li class="nav-item dropdown p-0 m-0">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          ...
                          <ul class="dropdown-menu dropdown-submenu l">
                            <li>
                              <a class="dropdown-item border-bottom" href="roomdetails.html?location=malad&type=3bhk"><i
                                  class="fa-solid fa-hotel" style="color: #24d4fd"></i>
                                3Bhk Malad
                              </a>
                            </li>
                            <li>
                              <a class="dropdown-item " href="roomdetails.html?location=malad&type=4bhk"><i
                                  class="fa-solid fa-hotel" style="color: #24d4fd"></i>
                                4Bhk Malad
                              </a>
                            </li>
                          ...
                          <ul class="dropdown-menu dropdown-submenu">
                            <li>
                              <a class="dropdown-item border-bottom"
                                href="roomdetails.html?location=malad&type=apart"><i class="fa-solid fa-hotel"
                            ...
                            <li>
                              <a class="dropdown-item border-bottom"
                                href="roomdetails.html?location=malad&type=apart2"><i class="fa-solid fa-hotel"
                                  style="color: #24d4fd"></i>
                                Devshelters Malad
                              </a>
                            </li>
                            <li>
                              <a class="dropdown-item " href="roomdetails.html?location=goregon&type=apart"><i
                                  class="fa-solid fa-hotel" style="color: #24d4fd"></i>
              ...
              <div class="wow fadeInUp" data-wow-delay="0.2s">
                <form id="inquiryForm3" method="post">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="contact" placeholder="Your Contact" required
                          name="contactNumber" />
  ...
  <script>
    ...
    if (loct && checkIn && checkOut && guest && rooms && contactName && contactNumber && contactEmail) {
      document.querySelector(`#location`).value = loct;
    ...
    let inquiryForm2 = document.querySelector('#inquiryForm2')
    inquiryForm2.addEventListener('submit', (e) => {
      e.preventDefault()
      console.log('yes');
    })
