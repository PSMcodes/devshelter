      ...
      <div class="col-lg-9 d-flex flex-column justify-content-center">
        <div class="row gx-0 bg-white d-none d-lg-flex h-100">
          ...
          <div class="col-lg-5 px-5 text-end d-inline-flex align-items-center justify-content-center">
            <div>
              <a class="me-3" href="https://www.facebook.com/share/dyovuE3GajghUz1m/?mibextid=LQQJ4d" target="_blank"><i
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      ...
                      <ul class="dropdown-menu dropdown-submenu">
                        ...
                        <li>
                          <a class="dropdown-item" href="roomdetails.html?location=malad&type=service&subtype=4bhk"><i
                              class="fa-solid fa-hotel" style="color: #24d4fd"></i>
                            4Bhk Malad
                          </a>
                        </li>
                    ...
                    <li>
                      ...
                      <ul class="dropdown-menu dropdown-submenu">
                        <li>
                          <a class="dropdown-item border-bottom" href="roomdetails.html?location=malad&type=apart"><i
                              class="fa-solid fa-hotel" style="color: #24d4fd"></i>
                            Kalpataru Hometel Malad
                          </a>
                        </li>
                        <li>
                          <a class="dropdown-item border-bottom" href="roomdetails.html?location=malad&type=apart2"><i
                              class="fa-solid fa-hotel" style="color: #24d4fd"></i>
                            Devshelters Malad
                          </a>
                        </li>
                        <li>
                          <a class="dropdown-item" href="roomdetails.html?location=goregoan&type=apart"><i
                              class="fa-solid fa-hotel" style="color: #24d4fd"></i>
  ...
  <div class="container mt-5">
    ...
    <div class="row position-relative">
      <div class="col-lg-8">
        ...
        <div class="row mb-4">
          <div class="row mb-5">
            <div class="col-3 d-flex flex-column justify-content-center align-items-center border text-secondary p-3">
        ...
        <div class="position-sticky top-0">
          ...
          <form id="inquiryForm2" method="POST" enctype="multipart/form-data">
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" class="form-control" id="contact" placeholder="Your Contact" name="contactNumber"/>
                  <label for="contact">Your Contact</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-floating">
                  <input type="text" class="form-control" id="emailId" name="emailId" placeholder="Your Email" required/>
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="number" class="form-control" id="guest" placeholder="Guests" required />
              ...
              <div class="col-12">
                <div class="form-floating">
                  <textarea class="form-control" placeholder="Special Request" id="message" nmae="message"
...
<script>
  ...
  inquiryForm.addEventListener("submit", (e) => {
    ...
    $('#alert').html($('#alert').html() + '<br><br> <span class="h6 text-bg-success p-2 rounded-3">Processing </span>')
  });
