            ...
            <tr>
                ...
                <td>
                    <a href='#' class='edit-room' data-id='<?php echo $row['id']; ?>'
                        ...
                        data-max-capacity='<?php echo $row['max_capacity']; ?>'
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="manage_rooms.php" enctype="multipart/form-data">
                        ...
                        <input class="form-control my-2 d-inline" type="url" name="google_map_link" placeholder="Google Map Link" required>
                        <input class="form-control my-2 d-inline" type="number" name="max_capacity" placeholder="Max Capacity" required>
                        <input class="form-control my-2 d-inline" type="file" name="image" required>
    ...
    <div class="modal" id="myModal1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editRoomModal" method="POST" action="manage_rooms.php" enctype="multipart/form-data">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editLinks.forEach(function (link) {
                link.addEventListener('click', function () {
                    ...
                    var googleMapLink = this.getAttribute('data-google-map-link');
                    var maxCapacity = this.getAttribute('data-max-capacity');
                    ...
                    document.querySelector('#editRoomModal input[name="google_map_link"]').value = googleMapLink;
                    document.querySelector('#editRoomModal input[name="max_capacity"]').value = maxCapacity;
