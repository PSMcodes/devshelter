            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="manage_rooms.php" enctype="multipart/form-data">
                        <input class="form-control my-2 d-inline" type="text" name="room_number"
                        ...
                        <input class="form-control my-2 d-inline" type="number" step="0.01" name="price"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editLinks.forEach(function(link) {
            link.addEventListener('click', function() {
                ...
                document.querySelector('#editRoomModal input[name="room_number"]').value =
                    roomNumber;
                document.querySelector('#editRoomModal select[name="location_id"]').value =
                    locationId;
