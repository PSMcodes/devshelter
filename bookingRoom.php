...
<body>
    ...
    <div class="content" id="content">
        <div class="container-fluid bg-white p-0">
                        ...
                        <div class="row gx-0 bg-white d-none d-lg-flex h-100">
                            <div class="col-lg-7 px-5 text-start d-flex">
                                <div class="h-100 d-inline-flex align-items-center me-4">
                                    ...
                                    <a href="mailto:devshelters63@gmail.com"
            ...
            <!-- Booking Start -->
            <div class="container-fluid p-5 page-header img-fluid"
                style="background-image: url(img/main/Service_banner.jpg)">
                <h1 class="display-3 text-white mb-3 animated slideInDown text-center">
                Booking
              </h1>
                                      ...
                                      <div class="row g-2">
                                          ...
                                          <div class="col-md-3">
                                              <div class="date" data-target-input="nearest">
                                                  <input placeholder="Check In" class="form-control" type="text"
                                                      onfocus="(this.type='date')" onblur="(this.type='text')"
                                                      id="date0" name="checkIn" />
                                              </div>
                                          </div>
                                          <div class="col-md-3">
                                              <div class="date" data-target-input="nearest">
                                                  <input placeholder="Check Out" class="form-control" type="text"
                                                      onfocus="(this.type='date')" onblur="(this.type='text')"
                                                      id="date1" name="checkOut" />
                                              </div>
                                          </div>
                                          <div class="col-md-3">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                      <div class="drp-items">
                                                          ...
                                                          <div class="btn-div d-flex container-sm">
                                                              ...
                                                              <span type="text" id="adultCounter" readonly value="1"
                                                                  class="w-25 p-2">1</span>
                                                              <button type="button"
                                                      ...
                                                      <div class="drp-items">
                                                          ...
                                                          <div class="btn-div d-flex container-sm">
                                                              ...
                                                              <span type="text" id="childCounter" readonly value="0"
                                                                  class="w-25 p-2">0</span>
                                                              <button type="button"
                                                      ...
                                                      <div class="drp-items">
                                                          ...
                                                          <div class="btn-div d-flex container-sm">
                                                              <button type="button" onclick="decrementRoomCounter()"
                                                                  class="btn btn-primary btn-about">
                                                                  -
                                                              </button>
                                                              <span type="text" id="roomCounter" readonly value="1"
                                                                  class="w-25 p-2">1</span>
                                                              <button type="button"
