            ...
            <div class="col-lg-9 d-flex flex-column justify-content-center">
              <div class="row gx-0 bg-white d-none d-lg-flex h-100">
                <div class="col-lg-7 px-5 text-start d-flex">
                  ...
                  <div
                    class="h-100 d-inline-flex align-items-center d-flex mx-2"
                  >
                  ...
                  >
                    <i class="fa fa-phone-alt text-primary me-2"></i>
                    <a href="tel:+91 7039433505 " class="mb-0 text-dark"
                      >+917039433505</a
                    >
                  </div>
                </div>
                ...
                >
                  <div>
                    ...
                    <a
                      class="me-3"
                      href="https://www.instagram.com/dev.shelters/"
                      target="_blank"
                      ><i class="fab fa-instagram"></i
                    ></a>
                    <a
                      class="me-3"
                      href="https://www.youtube.com/@devshelters9739"
                      target="_blank"
...
error_reporting(E_ALL);
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  ...
                  src="img/malad/3bhk/IMG_2073.JPG"
                  alt="Image"
                />
                <div
              ...
              <div class="carousel-item">
                <img
                  class="w-100 h-100 carousel-image"
                  src="img/goregaon-aparthotel/IMG_3286.JPG"
                  alt="Image"
                />
                <div
                  class="carousel-caption d-flex flex-column align-items-center justify-content-center"
              ...
              <div class="carousel-item">
                <img
                  class="w-100 h-100 carousel-image"
                  src="img/malad-aparthotel/IMG_E6114.JPG"
                  alt="Image"
                />
                <div
                  class="carousel-caption d-flex flex-column align-items-center justify-content-center"
              ...
              <div class="carousel-item">
                <img
                  class="w-100 h-100 carousel-image"
                  src="img/goregaon-aparthotel/IMG_3302.JPG"
                  alt="Image"
                />
                <div
                  class="carousel-caption d-flex flex-column align-items-center justify-content-center"
                        ...
                        >
                          <div class="drp-items">
                            ...
                            <div class="btn-div d-flex container-sm">
                              <button
                                type="button"
                                onclick="decrementCounter('adultCounter')"
                              ...
                              <button
                                type="button"
                                onclick="incrementCounter('adultCounter')"
                                class="btn btn-primary btn-about"
                              >
                                +
                              </button>
                          ...
                          <div class="drp-items">
                            ...
                            <div class="btn-div d-flex container-sm">
                              <button
                                type="button"
                                onclick="decrementCounter('childCounter')"
                                class="btn btn-primary btn-about"
                              >
                                -
                              </button>
                              ...
                              <button
                                type="button"
                                onclick="incrementCounter('childCounter')"
                                class="btn btn-primary btn-about"
                              >
                                +
                              </button>
                          ...
                          <div class="drp-items">
                            ...
                            <div class="btn-div d-flex container-sm">
                              ...
                              <button
                                type="button"
                                onclick="incrementCounter('roomCounter')"
                                class="btn btn-primary btn-about"
                              >
                                +
                              </button>
          ...
          <div class="col-md-6">
            <div class="video">
              <button
                ...
                data-src="https://www.youtube.com/embed/C6ZQTMQ7k9A?si=YlIgMoi5oue9Y4iE"
      ...
      >
        <img
          src="img/main/dmrc logo.png"
          alt=""
          style="max-width: 50%; max-height: 80px; margin-right: 50px"
        />
        <img
          src="img/main/NPCI-Logo.png"
          alt=""
      ...
      <div class="carousel2 brand-bottom py-3">
        <div class="carousel-track-2">
          ...
          <div class="carousel-item2">
            <img
              src="img/brands/Muthoot_Finance_Logo.svg"
              alt="Client Logo 4"
            />
          </div>
        ...
        <div class="container pb-5">
          <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
              ...
              <p class="mb-2">
                <a href="tel:+91 7039433505" class="text-light"
                  ><i class="fa fa-phone-alt me-3"></i>+91 7039433505 (for
                  booking) <br
                /></a>
                <a href="tel:+91 8451880595" class="text-light"
                  ><i class="fa fa-headset me-3"></i>+91 8451880595 (for
                  business inquiry) <br />
                </a>
              </p>
              <p class="mb-2">
                <a href="mailto:devshelters63@gmail.com" class="text-light"
            ...
            <div class="col-lg-5 col-md-12">
              <div class="row gy-5 g-4">
                ...
                <div class="col-md-6 d-flex flex-column">
                  <h6
                    class="text-start text-primary text-uppercase mb-4 section-title"
                  >
                    Social media
                  </h6>
                  <a
