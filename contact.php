            ...
            <div class="container text-center pb-5">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        ...
                        <li class="breadcrumb-item text-white active" style="font-size: 20px;" aria-current="page">Contact</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row gy-4">
                        <div class="col-md-4">
                            ...
                            <p><i class="fa fa-envelope-open text-primary me-2"></i>devshelters63@gmail.com</p>
                        </div>
                        <div class="col-md-4">
                            <h6 class="section-title text-start text-primary text-uppercase">Enquiry</h6>
                            <p><i class="fa fa-envelope-open text-primary me-2"></i>devshelters63@gmail.com</p>
                        </div>
                        <div class="col-md-4">
                            <h6 class="section-title text-start text-primary text-uppercase">B2B Tie-up</h6>
                            <p><i class="fa fa-envelope-open text-primary me-2"></i>devshelters63@gmail.com</p>
                          </div>
                      </div>
                  </div>
                  <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                      <!-- <iframe class="position-relative rounded w-100 h-100"
                          ...
                          tabindex="0"></iframe> -->
                          <iframe class="position-relative rounded w-100 h-100" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=%20Kalpataru%20Building,Evershine%20Nagar,%20Malad%20west%20Mumbai%20-400064,%20India+(DEVSHELTER)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"  frameborder="0" style="min-height: 350px; border:0;" allowfullscreen="" aria-hidden="false"
                          tabindex="0"><a href="https://www.gps.ie/">gps vehicle tracker</a></iframe>
                  </div>
                  <div class="col-md-6 py-8">
                      <div class=" form-container active" id="regular-form">
                        <button class="toggle-button "  onclick="toggleForms()">Switch to Normal Inquiry Form</button>
                        <h6 class=" text-right text-primary text-uppercase typewriter mb-2  " style="font-size: 20px;">Corporate Inquiry Form</h6>
                          <form>
                              <div class="row g-3">
                                  <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                  <div class="form-floating">
                                      <input type="text" class="form-control" id="name" placeholder="Company's Name">
                                      <label for="name">Company Name</label>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-floating">
                                      <input type="text" class="form-control" id="email" placeholder="Your Designation">
                    ...
                    <div class="form-container" id="corporate-form">
                      <button class="toggle-button btn-2" onclick="toggleForms()">Switch to Corporate Inquiry Form</button>
                      <h6 class=" text-right text-primary text-uppercase typewriter mb-2" style="font-size: 20px;">Normal Inquiry Form</h6>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
    ...
    <div class="container pb-5">
      <div class="row g-5">
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <p class="mb-2">
            <i class="fa fa-phone-alt me-3"></i>+91 7039433505 (for booking) <br>
            <i class="fa fa-headset me-3"></i>+91 8451880595 (for business enquiry) <br>
          </p>
          <p class="mb-2">
